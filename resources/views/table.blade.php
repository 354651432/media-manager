    ...
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <div class="box-body no-padding">
                ...
                <div class="mailbox-controls with-border {{ $canedit?'':'hide' }}">
                    <div class="btn-group">
                    ...
                    <div class="btn-group">
                        <a href="{{ route('media-index', ['path' => $url['path'], 'view' => 'table']) }}"
                           class="btn btn-default active"><i class="fa fa-list"></i></a>
                        <a href="{{ route('media-index', ['path' => $url['path'], 'view' => 'list']) }}"
                    ...
                    <table class="table table-hover">
                        <tbody>
                            ...
                            <input type="checkbox" value="{{ $item['name'] }}"/>
                                    ...
                                    <td class="action-row">
                                        <div class="btn-group btn-group-xs" {!!  $canedit?'':'style="display: none;"'  !!}>
